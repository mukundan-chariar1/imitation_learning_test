...
if __name__=='__main__':
    ...
    train_func=functools.partial(ppo.train,  num_timesteps=1_000_000, num_evals=10, reward_scaling=0.1, episode_length=1000, normalize_observations=True, action_repeat=1, unroll_length=10, num_minibatches=32, num_updates_per_batch=8, discounting=0.97, learning_rate=3e-4, entropy_cost=1e-3, num_envs=128, batch_size=64, seed=1)
