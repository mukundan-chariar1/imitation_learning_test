# # Use NVIDIA CUDA base image instead of plain Ubuntu
...
# # Instead of activating the environment, use the environment's executable directly
# # This approach bypasses the need for conda activate
# ENV CONDA_ENV_PATH="/opt/conda/envs/irl-project"
# ENV PATH="$CONDA_ENV_PATH/bin:$PATH"

# # Set CUDA and JAX environment variables
...
# # Create an entrypoint script that installs requirements and handles JAX config
# RUN echo '#!/bin/bash \n\
...
# else \n\
#     echo "No GPU detected, forcing JAX to use CPU" \n\
